                    ...
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        if (idEnt.matches("[0-9]+") && idEnt.length() > 0) {
                            if (enterpriseOps.getEnterprise(Long.parseLong(idEnt)) == null) {
                                dialog.dismiss();
                                Toast t = Toast.makeText(MainActivity.this, R.string.no_encontrada, Toast.LENGTH_LONG);
                                t.show();
                            } else {
                                Intent i = new Intent(MainActivity.this, AddUpdateEnterprise.class);
                            ...
                            Toast.makeText(getApplicationContext(),R.string.solo_numero,Toast.LENGTH_SHORT).show();
                        }
                    }
                }).create()
                .show();
                    ...
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        if (idEnt.matches("[0-9]+") && idEnt.length() > 0) {
                            if (enterpriseOps.getEnterprise(Long.parseLong(idEnt)) == null) {
                                ...
                                text.setText(R.string.eliminacion_confirmacion);
                                ...
                                alertDialogBuilder
                                        ...
                                        .setPositiveButton("SI", new DialogInterface.OnClickListener() {
                                            ...
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                Toast t = Toast.makeText(MainActivity.this, R.string.eliminacion_satisfactoria, Toast.LENGTH_SHORT);
                                                t.show();
                                            }
                                        })
