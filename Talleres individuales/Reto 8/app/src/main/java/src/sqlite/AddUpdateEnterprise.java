        ...
        addUpdateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mode.equals("Add")) {
                    ...
                    Toast t = Toast.makeText(AddUpdateEnterprise.this, R.string.creacion_satisfactoria + newEnterprise.getName(), Toast.LENGTH_SHORT);
                    t.show();
                    ...
                    Toast t = Toast.makeText(AddUpdateEnterprise.this, R.string.edicion_satisfactoria + oldEnterprise.getName(), Toast.LENGTH_SHORT);
                    t.show();
                    Intent i = new Intent(AddUpdateEnterprise.this, MainActivity.class);
                    startActivity(i);
